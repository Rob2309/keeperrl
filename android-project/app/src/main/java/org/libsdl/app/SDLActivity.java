...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    public static final boolean mHasMultiWindow = true; //(Build.VERSION.SDK_INT >= 24  /* Android 7.0 (N) */);
    ...
    protected String[] getArguments() {
        return new String[] {
                "--data_dir=" + getExternalFilesDir(null).getAbsolutePath(),
                "--user_dir=" + getExternalFilesDir(null).getAbsolutePath(),
        };
    }
    ...
    private void unpackRecursive(AssetManager assets, File destDir, String dir) {
        try {
            for(String file : assets.list(dir)) {
                ...
                if(file.contains(".")) {
                    ...
                    InputStream in = assets.open(openPath);
                    ...
                    unpackRecursive(assets, new File(destDir, file), openPath);
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        unpackRecursive(getAssets(), getExternalFilesDir(null), "");
